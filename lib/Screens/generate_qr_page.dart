...
class _GenerateQRPageState extends State<GenerateQRPage> {
  ...
  Future<void> generateQRCode(context) async {
    ...
    final file = File("${_appDocDirFolder.path}/$formattedDate.pdf");
    await file.writeAsBytes(pdf.save());
    writeBatch.commit().then((_) {
      setState(() {
        textMsg = 'PDF is created.';
        belowTextMsg = '${_appDocDirFolder.path}/$formattedDate.pdf';
      });
    });
  }
            ...
            content: Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    'PDF Mode : ' + (isSwitched ? 'Portrait' : 'Landscape'),
                    style: TextStyle(
                        color: Colors.white,
                        fontWeight: FontWeight.w400,
                        fontSize: 14),
  ...
  Future<void> shareFile(path) async {
    await Share.shareFiles([path], text: "Print");
  }
                      ...
                      textMsg == "No Product Data!"
                          ...
                          : Row(
                              ...
                              children: [
                                RaisedButton(
                                  elevation: 5.0,
                                  onPressed: () => shareFile(belowTextMsg),
                                ...
                                RaisedButton(
                                  elevation: 5.0,
                                  onPressed: () => openFile(belowTextMsg),
                                  padding: EdgeInsets.all(10.0),
                                  shape: RoundedRectangleBorder(
                                    borderRadius: BorderRadius.circular(30.0),
                                  ),
